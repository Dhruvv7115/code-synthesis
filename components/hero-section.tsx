...
export default function HeroSection({ isDarkMode, cardClasses }: HeroSectionProps) {
  ...
  return (
    ...
    >
      <motion.div variants={containerVariants} initial="hidden" animate="visible" className="max-w-6xl mx-auto">
        ...
        >
          Join us for an extraordinary journey of coding, innovation, and creativity
        </motion.p>
        ...
        {/* Stats Cards */}
        <motion.div variants={itemVariants} className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 max-w-4xl mx-auto">
          <motion.div
          ...
          >
            ...
            <div className="relative z-10 text-center">
              ...
              <div className="text-green-400 text-xs mt-1 font-medium">From across India</div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="relative z-10 text-center">
              ...
              <div className="text-green-400 text-xs mt-1 font-medium">+ Mentorship & Funding</div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="relative z-10 text-center">
              ...
              <div className="text-green-400 text-xs mt-1 font-medium">Connect with Teams</div>
            </div>
          </motion.div>
        </motion.div>
