...
export default function BroughtToYouSection({ isDarkMode, cardClasses, accentColor }: BroughtToYouSectionProps) {
  ...
  return (
    <section className={`relative py-16 px-6 md:px-12 ${isDarkMode ? "bg-gray-900/20" : "bg-gray-50/50"}`} ref={ref}>
      <motion.div
      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center mb-16">
          ...
          <p className={`${isDarkMode ? "text-gray-400" : "text-gray-600"} text-lg max-w-2xl mx-auto`}>
            Meet the institutions and team behind Code Synthesis
          </p>
        </motion.div>
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <p className={`${isDarkMode ? "text-gray-300" : "text-gray-700"} text-sm leading-relaxed`}>
                    A premier institution fostering innovation and excellence in engineering education, committed to
                ...
                <div className="relative z-10">
                  ...
                  <div className="aspect-video rounded-2xl overflow-hidden mb-6 shadow-lg bg-gradient-to-br from-gray-800 to-gray-900 flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <p className="text-green-400 font-bold">CODE GEEKS TEAM</p>
                    </div>
                  </div>
                  ...
                  <p className={`${isDarkMode ? "text-gray-300" : "text-gray-700"} text-sm leading-relaxed`}>
                    A passionate team dedicated to fostering tech innovation and creating meaningful experiences for the
                    developer community.
                  </p>
                </div>
              </motion.div>
