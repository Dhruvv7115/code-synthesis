                ...
                {category.members.map((member, memberIndex) => (
                  <motion.div
                    ...
                    className={`
                      ...
                      ${
                        isDarkMode
                          ? "bg-gray-800/40 border-gray-700 hover:border-green-400"
                          : "bg-white border-gray-200 hover:border-green-400"
                      } 
                      border-2 rounded-2xl p-8 w-full 
                  ...
                  >
                    ...
                    <div className="relative z-10 text-center h-full flex flex-col">
                      {/* Profile Image */}
                      <div className="mb-6">
                        <div className="w-32 h-32 rounded-full mx-auto border-4 border-green-400/30 group-hover:border-green-400 transition-all duration-300 shadow-lg overflow-hidden">
                          <Image
                      ...
                      <div className="flex-grow">
                        ...
                        <p className="text-green-400 font-bold mb-4 text-sm uppercase tracking-wide">
                          {member.role}
                        </p>
                      </div>
