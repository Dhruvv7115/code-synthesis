...
export default function AboutSection({ isDarkMode, cardClasses, accentColor }: AboutSectionProps) {
    ...
    <section id="about" className="relative py-24 px-6 md:px-12" ref={ref}>
      ...
      >
        <motion.div variants={itemVariants} className="text-center mb-20">
          ...
          >
            After CodeZen, we promised you something even bigger. Code Synthesis is that promise fulfilled—a fusion of
            technology with environmental impact in the most unexpected way.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className={`${isDarkMode ? "text-gray-300" : "text-gray-700"} leading-relaxed text-sm`}>
                Push the boundaries of technology to solve environmental challenges with creative, cutting-edge
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className={`${isDarkMode ? "text-gray-300" : "text-gray-700"} leading-relaxed text-sm`}>
                Create solutions with real-world applications that contribute to sustainable development and
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className={`${isDarkMode ? "text-gray-300" : "text-gray-700"} leading-relaxed text-sm`}>
                Connect with like-minded innovators, sustainability experts, and industry leaders in our thriving
                ecosystem.
              </p>
            </div>
          </motion.div>
        ...
        >
          ...
          <p
            className={`${isDarkMode ? "text-gray-300" : "text-gray-700"} text-base leading-relaxed max-w-4xl mx-auto`}
          >
            "To empower the next generation of developers and innovators to create technology solutions that not only
            solve problems but also contribute to a sustainable and environmentally conscious future. We believe that
            code can be a catalyst for positive change."
          </p>
        </motion.div>
      </motion.div>
    </section>
